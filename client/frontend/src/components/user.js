...
//------------------Check for register form validation------------
...
//-----------------------Login submit------------------
  ...
  //---------------code for password hide/show & navbar sliding --------
  constructor(props) {
    super(props);
    this.state = {
      menu: false,
                      ...
                      <Form>
                        <Form.Group controlId="formBasicname" className="text-light">
                          <Form.Label >Name</Form.Label>
                           <input
                            ...
                            <p style={{ fontSize: 14, color: "red" }}>{this.state.nameError}</p>
                        </Form.Group>
                        <Form.Group controlId="formBasicEmail" className="text-light">
                          <Form.Label>Email address</Form.Label>
                            ...
                            <p style={{ fontSize: 14, color: "red" }}>{this.state.emailError}</p>
                        </Form.Group>
                        ...
                        <Form.Group controlId="formBasicPassword" className="text-light">
                          <Form.Label >Password</Form.Label>
                            <div>
                              ...
                              <p style={{ fontSize: 14, color: "red" }}>{this.state.passError}</p>
                            </div>
                        </Form.Group>
                          <Button 
