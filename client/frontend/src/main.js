...
// import {action ,user}  from './reducer/userstore'
...
class Main extends React.Component {
  ...
  render() {
     ...
     console.log("nam",this.props.auth)
    return (
      // <BrowserRouter>
          ...
          {localStorage.getItem('token') ?
             <div>
               <div className="hheading">
                  <div className="heading">welcome,&nbsp;<mark className="heading text-warning">{this.props.state.auth.name}</mark>&nbsp;&nbsp;Check out how much u know about Corona&nbsp;&nbsp;<Link onClick={refreshPage} className="hheading text-warning">Logout</Link></div>
                </div>
